...
typedef struct headerPage {
    ...
    int64_t num_pages;
    uint64_t hp_lsn; //24-32byte
    char reserved[4064]; //4096-32
}headerPage;
...
typedef struct generalPage {
    ...
    uint32_t isLeaf; // 8-12byte
    uint32_t num_keys; // 12-16byte
    char reserved[8]; // 16-24byte
    uint64_t page_lsn; //24-32byte
    char reserved2[96]; //32-128byte
